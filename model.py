...
class Upscale(nn.Module):
    ...
    def __init__(self, input_chanels, n_features):
        ...
        self.t_conv_1 = nn.ConvTranspose2d(input_chanels, n_features, kernel_size = 5, stride = 2, padding = 2, output_padding = 1)
        ...
        self.conv_4 = nn.Conv2d(n_features*40, input_chanels, kernel_size = 5, padding = 2)
